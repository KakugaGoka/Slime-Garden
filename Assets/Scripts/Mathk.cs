...
namespace Kico
{
    public static class Mathk
    {
        ...
        public static float MaxOfFloatArray(float[] array)
        {
        ...
        public static float MinOfFloatArray(float[] array)
        {
        ...
        public static float MaxOfFloatList(List<float> list)
        {
            float max = -100000000000000000000000000000000000000f;
        ...
        public static float MinOfFloatList(List<float> list)
        {
            float min = 100000000000000000000000000000000000000f;
            for (int i = 0; i < list.Count; i++)
            {
        ...
        public static float AverageOfFloatArray(float[] array)
        {
            float total = 0f;
            for (int i = 0; i < array.Length; i++)
            {
        ...
        {
            float max = MaxOfFloatArray(array);
            float min = MinOfFloatArray(array);
            float range = max - min;
        ...
        public static void RescaleFloatArray(float[] array, float min, float max)
        {
            ...
            BlendFloatArray(Blend.Mult, max - min, array);
            BlendFloatArray(Blend.Add, min, array);
        }
        ...
        public static float Similarity(float[] arrayA, float[] arrayB, float strictness)
        {
            ...
            return MinOfFloatArray(comparisons);
        }
    }

    public static class Vectork
    {
    ...
    {
        public static Func<float, float, float> Add = (x, y) =>
        {
            return x + y;
        };

        public static Func<float, float, float> Sub = (x, y) =>
        {
            return x - y;
        };

        public static Func<float, float, float> Mult = (x, y) =>
        {
            return x * y;
        };

        public static Func<float, float, float> Div = (x, y) =>
        {
            return x / y;
        };

        public static Func<float, float, float> Max = (x, y) =>
        {
            return Mathf.Max(x, y);
        };

        public static Func<float, float, float> Min = (x, y) =>
        {
            return Mathf.Min(x, y);
        };

        public static Func<float, float, float> Set = (x, y) =>
        {
            return y;
        };
    }
